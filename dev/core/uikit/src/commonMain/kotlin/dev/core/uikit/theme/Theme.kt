...
fun AppTheme(
    ...
    val fontFamily = rememberScFontFamily()
    CompositionLocalProvider(
        LocalDarkTheme provides darkTheme,
        LocalScFontFamily provides fontFamily,
        // `Sc.*` rang tokenlari shu yerdan o'qiydi — dark/light shu bilan almashadi.
        LocalScColors provides if (darkTheme) DarkScColors else LightScColors,
    ) {
        MaterialTheme(
