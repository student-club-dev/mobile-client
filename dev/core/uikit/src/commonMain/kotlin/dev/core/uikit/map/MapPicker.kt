 ...
 *
 * Xarita — [OffersMap] bilan **bitta dvigatel** (MapLibre GL JS, [mapStyleUrl] uslubi).
 * Ilgari bu ekran o'zining qo'lda yozilgan raster plitka dvigatelida ishlar va e'lonlar
 * xaritasidan butunlay boshqacha ko'rinardi; endi ikkalasi bir xil.
 *
 * @param initial xarita ochilishidagi markaz (odatda foydalanuvchining joylashuvi)
 * @param dark qorong'i mavzu uslubi
