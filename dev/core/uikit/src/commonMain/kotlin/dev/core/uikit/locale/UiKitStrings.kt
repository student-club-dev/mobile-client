...
data class UiKitStrings(
    ...
    /** Xarita ustidagi nishon: nechta e'lon ko'rsatilyapti. */
    val listingsOnMap: (Int) -> String = { "$it listings on the map" },
...
private val UiKitRu = UiKitStrings(
    ...
    listingsOnMap = { "$it объявлений на карте" },
...
private val UiKitUz = UiKitStrings(
    ...
    listingsOnMap = { "$it ta e'lon xaritada" },
