...
//
// Bu modul kod chiqarmaydi: u faqat spec'ni (`student-club.json`) ushlaydi, normalizatsiya qiladi va
...
val specFile = layout.projectDirectory.file("student-club.json")
 ...
 * necha naqsh bor; hammasi shu yerda tuzatiladi, `student-club.json` faylining o'ziga TEGILMAYDI —
...
tasks.register("generateAllApi") {
    group = "openapi"
    description = "Barcha OpenAPI klientlarini generatsiya qiladi (student-club.json)"
