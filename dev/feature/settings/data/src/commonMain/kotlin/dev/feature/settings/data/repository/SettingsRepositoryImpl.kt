package dev.feature.settings.data.repository
...
class SettingsRepositoryImpl(
    ...
    override suspend fun setFlag(key: String, value: Boolean) = withContext(dispatchers.io) { q.upsert(key, value.toString()) }

    override fun observeValue(key: String): Flow<String?> = q.selectByKey(key).asFlow().mapToOneOrNull(dispatchers.io)
