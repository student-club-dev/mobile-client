...
class NotificationRepositoryImpl(
    ...
    override suspend fun markRead(id: String) = withContext(dispatchers.io) { q.markRead(id) }
    override suspend fun markAllRead() = withContext(dispatchers.io) { q.markAllRead() }
    ...
    private fun NotificationEntity.toDomain(): AppNotification = AppNotification(
        ...
        timeLabel = timeLabel, read = read != 0L,
    )
}
