...
internal fun offersMapHtml(center: MapPoint, markers: List<OfferMarker>, dark: Boolean, userLocation: MapPoint?, bottomInset: Int): String {
    val styleUrl = if (dark) "https://basemaps.cartocdn.com/gl/dark-matter-gl-style/style.json"
...
<head>
  ...
  <style>
    ...
    #map { position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: ${if (dark) "#12101F" else "#E8E6F2"}; }
